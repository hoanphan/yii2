                                ...
                                <div id="member-tab" class="tab-pane">
                                    <div class="clearfix">
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Bob Doe's avatar" src="<?=$bundle->baseUrl?>/avatars/user.jpg">
                                            </div>
                                        ...
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Joe Doe's avatar" src="<?=$bundle->baseUrl?>/avatars/avatar2.png">
                                            </div>
                                        ...
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Jim Doe's avatar" src="<?=$bundle->baseUrl?>/avatars/avatar.png">
                                            </div>
                                        ...
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Alex Doe's avatar" src="<?=$bundle->baseUrl?>/avatars/avatar5.png">
                                            </div>
                                        ...
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Bob Doe's avatar" src="<?=$bundle->baseUrl?>/avatars/avatar2.png">
                                            </div>
                                        ...
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Susan's avatar" src="<?=$bundle->baseUrl?>/avatars/avatar3.png">
                                            </div>
                                        ...
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Phil Doe's avatar" src="<?=$bundle->baseUrl?>/avatars/avatar4.png">
                                            </div>
                                        ...
                                        <div class="itemdiv memberdiv">
                                            <div class="user">
                                                <img alt="Alexa Doe's avatar" src="<?=$bundle->baseUrl?>/avatars/avatar1.png">
                                            </div>
                                ...
                                <div id="comment-tab" class="tab-pane">
                                    <div class="comments ace-scroll" style="position: relative;"><div class="scroll-track" style="display: none;"><div class="scroll-bar"></div></div><div class="scroll-content" style="max-height: 300px;">
                                            <div class="itemdiv commentdiv">
                                                <div class="user">
                                                    <img alt="Bob Doe's Avatar" src="<?=$bundle->baseUrl?>/avatars/avatar.png">
                                                </div>
                                            ...
                                            <div class="itemdiv commentdiv">
                                                <div class="user">
                                                    <img alt="Jennifer's Avatar" src="<?=$bundle->baseUrl?>/avatars/avatar1.png">
                                                </div>
                                            ...
                                            <div class="itemdiv commentdiv">
                                                <div class="user">
                                                    <img alt="Joe's Avatar" src="<?=$bundle->baseUrl?>/avatars/avatar2.png">
                                                </div>
                                            ...
                                            <div class="itemdiv commentdiv">
                                                <div class="user">
                                                    <img alt="Rita's Avatar" src="<?=$bundle->baseUrl?>/avatars/avatar3.png">
                                                </div>
                        ...
                        <div class="widget-main no-padding">
                            <div class="dialogs ace-scroll"><div class="scroll-track scroll-active" style="display: block; height: 300px;"><div class="scroll-bar" style="height: 236px; top: 0px;"></div></div><div class="scroll-content" style="max-height: 300px;">
                                    <div class="itemdiv dialogdiv">
                                        <div class="user">
                                            <img alt="Alexa's Avatar" src="<?=$bundle->baseUrl?>/avatars/avatar1.png">
                                        </div>
                                    ...
                                    <div class="itemdiv dialogdiv">
                                        <div class="user">
                                            <img alt="John's Avatar" src="<?=$bundle->baseUrl?>/avatars/avatar.png">
                                        </div>
                                    ...
                                    <div class="itemdiv dialogdiv">
                                        <div class="user">
                                            <img alt="Bob's Avatar" src="<?=$bundle->baseUrl?>/avatars/user.jpg">
                                        </div>
                                    ...
                                    <div class="itemdiv dialogdiv">
                                        <div class="user">
                                            <img alt="Jim's Avatar" src="<?=$bundle->baseUrl?>/avatars/avatar4.png">
                                        </div>
